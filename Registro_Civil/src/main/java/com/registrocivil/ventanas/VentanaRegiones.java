...
public class VentanaRegiones extends JFrame {
    ...
    private void initComponents() {
        ...
        titulo.setForeground(VentanaMenu.COLOR_TITULO);
        ...
        JButton btnListadoCiudadanos = VentanaMenu.crearBoton("Ciudadanos por región");
        JButton btnMatrimonios     = VentanaMenu.crearBoton("Matrimonios por región");
        JButton btnEstadisticas    = VentanaMenu.crearBoton("Estadísticas generales");
        ...
        panelPrincipal.add(VentanaMenu.crearBotonVolver(this), BorderLayout.SOUTH);
        add(panelPrincipal);
    }
