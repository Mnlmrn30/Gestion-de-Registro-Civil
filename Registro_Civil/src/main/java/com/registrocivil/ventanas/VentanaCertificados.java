...
public class VentanaCertificados extends JFrame {
    ...
    private void emitir() {
        try {
            ...
            if (p == null) {
                areaCertificado.setText("Error: No se encontro ciudadano con RUT " + rut);
                return;
            }
            ...
            areaCertificado.setText("Error de validacion de RUT:\n" + e.getMessage());
        } catch (Exception e) {
            areaCertificado.setText("Error inesperado: " + e.getMessage());
        }
    }
}
