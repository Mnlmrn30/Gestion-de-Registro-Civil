...
public class VentanaMenu extends javax.swing.JFrame {
    ...
    private void defuncionActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if (rut != null && !rut.isEmpty()) {
            ...
            if (p != null) {
                // p.setVivo(false); <-- Esto ya no sirve solo. Más adelante hay que hacer un UPDATE en SQLite.
                JOptionPane.showMessageDialog(this, "¡Persona encontrada en BD! (Nota para después: Falta programar el UPDATE en SQLite para cambiar su estado).");
            } else {
                JOptionPane.showMessageDialog(this, "RUT no encontrado en la Base de Datos.");
            }
        }
    }
